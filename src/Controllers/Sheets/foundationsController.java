...
public class foundationsController implements Initializable {
    ...
    public GridPane POST_FOOTINGS, CONCRETE_BORES, FOOTINGS, CONCRETE_FLOOR, RAFT_PILES,
            RAFT_FOOTINGS, RAFT_SLAB, PATIO_FOOTINGS, PATIO_SLAB, CARPOT_FOOTINGS, CARPOT_SLAB,
            DECK_FOOTING, DECK_SLAB, WALL_PLATES, WATER_PROOFING, COLUMNS, BEAMS, CONCRETE_WALL,
            CONC_STEPS, BLOCK_CNRS_ENDS, SITE_WORKS, PROFILES, BOXING;
