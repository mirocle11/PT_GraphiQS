 ...
 */
public class Cladding implements IMeasurement {
    Tools tools;
    boolean isNew = true;
    Line line;
    Circle circle;
    ...
    public Cladding(Tools tools) {
        ...
        this.line.setStroke(tools.window.CLD_COLOR_PICKER.getValue());
    ...
    public void handleFinish() {
        CladdingObject claddingObject = new CladdingObject();
        claddingObject.setPane(pane);
        claddingObject.setStrokeWidth(8 / group.getScaleY());
        claddingObject.setColor(tools.window.CLD_COLOR_PICKER.getValue());
    ...
    public void handleShowContextMenu(MouseEvent event) {
        ...
        if (event.getButton() == MouseButton.SECONDARY) {
            ...
            MenuItem finish = new MenuItem("Complete Cladding");
