...
public class claddingMaterials extends RecursiveTreeObject<claddingMaterials> {

    private SimpleStringProperty sku_number, description, unit, quantity;

    public claddingMaterials(String sku_number, String description, String unit, String quantity) {
