...
public class framingHardwareMaterials extends RecursiveTreeObject<framingHardwareMaterials> {

    private SimpleStringProperty sku_number, description, unit, quantity;

    public framingHardwareMaterials(String sku_number, String description, String unit, String quantity) {
