...
public class externalFramingData extends RecursiveTreeObject<externalFramingData> {

    private SimpleStringProperty no, sku_number, description, unit;

    public externalFramingData(String no, String sku_number, String description, String unit) {
