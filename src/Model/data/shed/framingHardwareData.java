...
public class framingHardwareData extends RecursiveTreeObject<framingHardwareData> {

    private SimpleStringProperty no, sku_number, description, unit;

    public framingHardwareData(String no, String sku_number, String description, String unit) {
