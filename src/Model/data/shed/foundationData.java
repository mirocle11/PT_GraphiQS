...
public class foundationData extends RecursiveTreeObject<foundationData> {

    private SimpleStringProperty no, sku_number, description, unit;

    public foundationData(String no, String sku_number, String description, String unit) {
